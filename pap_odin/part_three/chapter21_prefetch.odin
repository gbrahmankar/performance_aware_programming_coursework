...
foreign prefetch {
	traverse_links_without_prefetch :: proc(outer: u64, src_data: ^u8, inner: u64, dst_data: ^u8) -> u64 --- 
	traverse_links_with_prefetch :: proc(outer: u64, src_data: ^u8, inner: u64, dst_data: ^u8) -> u64 --- 
}
